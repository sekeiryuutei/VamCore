...
public class DeleteFileUseCase {
    ...
    public DeleteFileUseCase(FileMetadataRepository fileMetadataRepository, FileStoragePort fileStoragePort) {
        this.fileMetadataRepository = fileMetadataRepository;
        this.fileStoragePort = fileStoragePort;
    }

    @Transactional
    public void handle(UUID fileId) {
        ...
        fileStoragePort.delete(metadata.storageKey());
        fileMetadataRepository.deleteById(tenantId.value(), fileId);
    }
}
